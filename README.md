...
The analysis reveals that digital exclusion in Cusco is not the exception but the norm: the vast majority of the territory falls into the **Critical Divide** category (VNL < 0.15 and connectivity < 0.15), with over 90% of pixels showing maximum social exclusion risk. Mobile connectivity is highly concentrated along the Cusco–Urubamba–Quillabamba corridor and is largely absent across the remote Andes highlands and high jungle, even in areas with detectable nighttime light. The Pearson correlation between nighttime light intensity and mobile coverage is only moderate (r ≈ 0.35), confirming that urbanization and digital access do not overlap spatially — a significant portion of populated areas remains disconnected from mobile networks.
